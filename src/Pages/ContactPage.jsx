...
// const ContactPage = () => {
//   return (
//     <div className='flex flex-col md:flex-row mt-10 mx-auto px-10 justify-between max-w-7xl '>
...
//         <div className='flex flex-col gap-y-3 md:flex-row  space-x-3 items-center justify-center'>
//             <input type="text" name="" id="" placeholder='Your Name' className='flex-1 w-full rounded px-2 py-2 border bg-gray-200 text-black'/>
//             <input type="text" name="" id="" placeholder='Your Email' className='flex-1 w-full rounded px-2 py-2 border bg-gray-200 text-black' />
//             <input type="text" name="" id="" placeholder='Your Phone' className='flex-1 w-full rounded px-2 py-2 border bg-gray-200 text-black'/>
//         </div>
//         <div>
//             <input type="text" name="" id="" placeholder='Your Message' 
//             className='h-32 px-2 py-2 border bg-gray-200 text-black mt-5 w-full flex-1 rounded'
//             />
//         </div>
